...
Merk LAPTOP: <br />
	<input type="checkbox" name="merk[]" value="Thosiba" checked="yes" />Thosiba <br />
	...
	<input type="checkbox" name="merk[]" value="Acer" />Acer <br />
	<input type="checkbox" name="merk[]" value="Lenovo" />Lenovo <br />
	<input type="checkbox" name="merk[]" value="Dell" />Dell <br />
